...
df = pd.DataFrame(columns=["Model", "Standardize",
                  "Normalize", "PCA", "F1-Stratified", "F1", "Runtime"])
...
for filename in filenames:
    ...
    df.loc[len(df)] = [model_name, standardize,
                       normalize, pca, f1_stratified, f1, runtime]
